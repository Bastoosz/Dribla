...
const LoginPage = ()=>{
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(null); // Estado para exibir o erro na UI
    const handleLogin = async (e)=>{
        e.preventDefault();
        setLoading(true);
        setError(null); // Limpa erros anteriores
        const { data, error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            email: email,
            password: password
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__98d2cbb8._.js.map