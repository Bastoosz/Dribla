...
const ModalNovoAluno = ({ onClose, onAlunoAdicionado })=>{
    ...
    const [valor, setValor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    // Padrão para hoje no formato YYYY-MM-DD
    const hoje = new Date().toISOString().slice(0, 10);
    const [vencimento, setVencimento] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(hoje);
    // NOVO ESTADO: Controla se o pagamento inicial foi feito (true = pago, false = não pago)
    const [foiPagoInicialmente, setFoiPagoInicialmente] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true); // Padrão 'pago'
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: treinadorData, error: treinadorError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('treinadores').select('plano_atual, limite_alunos').eq('id', user.id).single();
            if (treinadorError) throw treinadorError;
            const { count: alunosAtuais, error: countError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('alunos').select('*', {
                count: 'exact',
                head: true
            ...
            const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('alunos').insert([
                payload
            ]);
            if (insertError) {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    !foiPagoInicialmente && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(ModalNovoAluno, "GmwTd7+sD+RJ3UoajagLODuUh44=");
_c = ModalNovoAluno;
...
const ElencoPage = ()=>{
    ...
    const [currentFilter, setCurrentFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(initialFilter);
    ...
    const fetchAlunos = async ()=>{
        ...
        // Monta a query base
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('alunos').select('*').eq('id_treinador', user.id); // Filtra sempre pelo treinador logado
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Layout$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                children: [
                    ...
                    !loading && !error && alunos.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    showModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ModalNovoAluno$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(ElencoPage, "dGnddtDySc6slH701ULTz8KZc8Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc1ea251._.js.map