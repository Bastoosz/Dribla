...
"[project]/pages/cadastro.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabaseClient.ts [client] (ecmascript)"); // Importa o cliente Supabase
...
const CadastroPage = ()=>{
    ...
    const handleCadastro = async (e)=>{
        ...
        const { data: signUpData, error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email: email,
            password: password,
            options: {
...
_s(CadastroPage, "aY1tstSI0e/7MflmdwNEYt5AogQ=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/cadastro.tsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/cadastro";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/cadastro.tsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/pages/cadastro\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/cadastro.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__e622daa1._.js.map